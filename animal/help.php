...
<script>
    function find() {
        ...
        window.location.href='help.php?context='+context;
    }
    /**
     * 将关键字变为红色
...
if ($context==''||$context==null){
    $query1 = mysqli_query($_conn,"select * from yhb where power=3 order by id desc");
}
else{
    $sql = "select * from yhb where username like '%".$_GET['context']."%' and power=3 order by id desc";
                            ...
                            <table>
                                ...
                                <td style="vertical-align:middle;text-align:left;">
                                    <div class="artical-info" style="width:1000px;" id="test">                                         
                                        <h3 class="finKey">'.$row['username'].'<a href=talk.php?ToUserID='.$row['id'].'>聊天</a> </h3>                                      
                                        <a href=helpdengji.php?hid='.$row['id'].'>登记</a>
                                        <a href="z2.php?hid='.$row['id'].'">寄养</a>
                                        <a href="helplist.php?hid='.$row['id'].'">领养</a>
                                    </div>
                                </td>
                                </tr>
                            </table>
