...
<html>
    ...
    <body>
        ...
        ?>
        <div>
            <h3 style=" text-align:center; color:#000;margin-top:20px; margin-bottom:20px; font-size:28px; font-family:宋体">管理招领</h3>
            ...
            <div id="twjs">
                <table border=1px cellpadding="0" cellspacing="0" style=" width:70%; text-align:center;margin:0 auto; background:#FFF; opacity:0.8" >
                    <?php     
                        $a=$_COOKIE['yhm'];
                        $query1 = mysqli_query($_conn," select * from product where username= '$a'");
                        echo '
                            <tr height="30px">
                                <td>标题</td>  
                                <td>发布人</td>
                    ...
                    while($row = mysqli_fetch_array($query1)){
                        echo '
                                <tr>
                                    ...
                                    <td><a href=xiugai.php?id='.$row['id'].'>修改</a></td>
                ...
                if ($_GET['action']=="del"){
                    ...
                    echo "<script type='text/javascript'>alert('删除成功');window.location.href='shanchu1.php';</script>";
                }
                ?>
                <p>&nbsp;</p>
            </div>
